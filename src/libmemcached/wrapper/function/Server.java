...
public class Server extends Function {
    ...
    public static ReturnType memcached_server_add(memcached_st ptr, String hostname, int port){
        int rc = getMemcached().memcached_server_add(ptr, hostname, port);
