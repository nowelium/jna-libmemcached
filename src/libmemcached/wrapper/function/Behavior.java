...
public class Behavior extends Function {
    ...
    public static ReturnType memcached_behavior_set(memcached_st ptr, BehaviorType flag, long data){
        int rc = getMemcached().memcached_behavior_set(ptr, flag.getValue(), data);
