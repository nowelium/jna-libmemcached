...
public class MemcachedClient {
    ...
    public MemcachedServer createServer() {
        memcached_server_st server_st = handler.memcached_server_create(memcached_st, null);
        return new MemcachedServer(this, server_st);
    }
    
    public MemcachedServer createServer(String hostname, int port, int weight, ConnectionType type){
        memcached_server_st server_st = handler.memcached_server_create_with(memcached_st, null, hostname, port, weight, type.getValue());
        return new MemcachedServer(this, server_st);
    }
